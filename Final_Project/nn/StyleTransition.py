...
style = image_loader("images/style.jpg").type(dtype)
content = image_loader("images/content.jpg").type(dtype)
...
input = image_loader("images/content.jpg").type(dtype)
...
output_image.save('images/output.PNG')
